...
<!--	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css">
	...
	<!----------WOWHWAD NEWS WIDGET--------------->
	<script type="text/javascript" src="http://static.wowhead.com/widgets/newsfeed.js"></script>
...
<body>
	...
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark justify-content-between" >
	   ...
	   <form class = "form-inline" autocomplete="off" action="Armor.php" method = "post">
		  <div class="auto-widget">
			<input class="form-control mr-sm-2" id="search" type="text" name="search" placeholder="Search by item name...">
		  </div>
		<button class="btn btn-outline-success my-2 my-sm-0" type="submit" name = "navsearch">Search</button>
	</form>
	</nav>
