...
$username = $new_password = $confirm_password = $temp_name = "";
...
if(isset($_POST["submit"])){
	 ...
	 if(empty(trim($_POST["username"]))){
        $username_err = "Please enter username.";
			...
			$temp_name = trim($_POST["username"]);
			$sql = "SELECT username FROM users WHERE username = '{$temp_name}'";
	...
	if(empty($username_err) && empty($ne_password_err) && empty($confirm_password_err)){
	  ...
	  <h2>Reset Password Form</h2>
        <form style="margin: 0 40% 0 40%;" method = "post" action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
			<div class="form-group">
			  ...
			  <div class="form-group">
				<label for="password">New Password: (At least 6 characters)</label><span data-toggle="tooltip"  data-placement="top" title="Required Field" style = "color: red;">*<?php echo $new_password_err; ?></span>
				<input type="password" class="form-control" id="new_password" name= "new_password">
			  </div>
			  <div class="form-group">
				<label for="confirm_password">Confirm Password:</label><span data-toggle="tooltip" data-placement="top" title="Required Field" style = "color: red;">* <?php echo $confirm_password_err; ?> </span>
				<input type="password" class="form-control" id="confirm_password" name= "confirm_password">
			  </div>
			  <input type="submit" class="btn btn-primary" value="Reset" id="submit_btn" name="submit">
		</form>
