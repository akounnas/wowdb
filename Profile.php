...
<body>
	  ...
	  <div class="container-fluid" >
			<div class="row">
				<div class="col bg-dark text-center" style=" color: white;">
					<img src=<?php echo $_SESSION["image"]; ?> class="rounded-circle" style= "padding-top: 2%;"><br>
	...
	<div class="container-fluid">
			<div class="row">
				<div class="col bg-dark text-center" style=" color: white;">
					<h3 style="margin-bottom: 2%; ">Username: <?php echo htmlspecialchars($_SESSION["username"]); ?></h3>
	...
	echo "<div class='container-fluid'>
			<div class='row'>
				<div class='col bg-dark text-center' style=' color: white;'>
					<h4>Welcome Administrator if you want to add items use this form <a href='Items-Form.php'>Item Form</a></h4>
				</div>
			</div>
	</div>";
	}
  ...
  <div class="modal-dialog  bg-dark">
    <div class="modal-content  bg-dark">
      ...
      <div class="modal-header  bg-dark">
        <h4 class="modal-title  bg-dark">Choose Avatar</h4>
	  ...
	  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" id="form1">
		<div class="row">
			<div class="col bg-dark">
				<button class="btn" style="border: none; padding: 0; background: none; cursor: pointer;" type="submit" form="form1" value="Thrall" name="submit">
					<img src="IMG/Thrall.jpg" class="rounded-circle" style= "padding-top: 2%; width: 100%">
				</button>
			</div>
			<div class="col bg-dark">
				<button class="btn" style="border: none; padding: 0; background: none; cursor: pointer;" type="submit" form="form1" value="Sylvanas" name="submit">
					<img src="IMG/Sylvanas.jpg" class="rounded-circle" style= "padding-top: 2%; width: 100%">
				</button>
			</div>
			<div class="col bg-dark">
				<button class="btn" style="border: none; padding: 0; background: none; cursor: pointer;" type="submit" form="form1" value="Rexxar" name="submit">
					<img src="IMG/Rexxar.jpg" class="rounded-circle" style= "padding-top: 2%; width: 100%">
				</button>
			</div>
			<div class="col bg-dark">
				<button class="btn" style="border: none; padding: 0; background: none; cursor: pointer;" type="submit" form="form1" value="Valeera" name="submit">
					<img src="IMG/Valeera.jpg" class="rounded-circle" style= "padding-top: 2%; width: 100%">
				</button>
			</div>
			<div class="col bg-dark">
				<button class="btn" style="border: none; padding: 0; background: none; cursor: pointer;" type="submit" form="form1" value="Garrosh" name="submit">
					<img src="IMG/Garrosh.jpg" class="rounded-circle" style= "padding-top: 2%; width: 100%">
				</button>
			</div>
		</div>
		<div class="row" style="padding-top: 1%;">
			<div class="col bg-dark">
				<button class="btn" style="border: none; padding: 0; background: none; cursor: pointer;" type="submit" form="form1" value="Malfurion" name="submit">
					<img src="IMG/Malfurion.jpg" class="rounded-circle" style= "padding-top: 2%; width: 100%">
				</button>
			</div>
			<div class="col bg-dark">
				<button class="btn" style="border: none; padding: 0; background: none; cursor: pointer;" type="submit" form="form1" value="Uther" name="submit">
					<img src="IMG/Uther.jpg" class="rounded-circle" style= "padding-top: 2%; width: 100%">
				</button>
			</div>
			<div class="col bg-dark">
				<button class="btn" style="border: none; padding: 0; background: none; cursor: pointer;" type="submit" form="form1" value="Guldan" name="submit">
					<img src="IMG/Guldan.jpg" class="rounded-circle" style= "padding-top: 2%; width: 100%">
				</button>
			</div>
			<div class="col bg-dark">
				<button class="btn" style="border: none; padding: 0; background: none; cursor: pointer;" type="submit" form="form1" value="Anduin" name="submit">
					<img src="IMG/Anduin.jpg" class="rounded-circle" style= "padding-top: 2%; width: 100%">
				</button>
			</div>
			<div class="col bg-dark">
				<button class="btn" style="border: none; padding: 0; background: none; cursor: pointer;" type="submit" form="form1" value="Jaina" name="submit">
					<img src="IMG/Jaina.jpg" class="rounded-circle" style= "padding-top: 2%; width: 100%">
				</button>
			</div>
		</div>
	  </form>
